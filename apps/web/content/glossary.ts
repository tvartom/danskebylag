...
export const glossary: GlossaryEntry[] = [
  ...
  },
  {
    da: 'Markfred',
    sv: 'Markfred',
    definition: 'Freden som rådde på de odlade fälten under odlingssäsongen, skyddad av stängsel och regler.',
    chapters: [7],
  },
  {
    da: 'Solskifte',
    sv: 'Solskifte',
    definition: 'Jordfördelningssystem där lotternas ordning följde gårdarnas läge i byn, "efter solens gång".',
    chapters: [8],
  },
  {
    da: 'Bolskifte',
