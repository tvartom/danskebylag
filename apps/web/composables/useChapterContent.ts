const danishFiles = import.meta.glob<string>('~/content/chapters/*/da.md', {
	query: '?raw',
	import: 'default',
})
const swedishFiles = import.meta.glob<string>('~/content/chapters/*/sv.md', {
	query: '?raw',
	import: 'default',
})
const summaryFiles = import.meta.glob<string>('~/content/chapters/*/summary.md', {
	query: '?raw',
	import: 'default',
})
